...
let SchedulesController = class SchedulesController {
    ...
    findByBarber(barberId) {
        return this.service.findByBarber(barberId);
    }
    findByBarberAndDay(barberId, day) {
...
], SchedulesController.prototype, "findByBarber", null);
__decorate([
    (0, common_1.Get)('barber/:barberId/day/:day'),
    __param(0, (0, common_1.Param)('barberId')),
    __param(1, (0, common_1.Param)('day')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], SchedulesController.prototype, "findByBarberAndDay", null);
__decorate([
    (0, common_1.Post)(),
